...
public class RedPoition extends Item {
    private Animation<TextureRegion> redPoitionAnimation;
    ...
    public RedPoition(PlayScreen screen, float x, float y) {
        ...
        redPoitionAnimation = new Animation<TextureRegion>(0.4f, frames);
        stateTimer = 0;
    ...
    public void update(float dt) {
        super.update(dt);
        stateTimer += dt;
        region = redPoitionAnimation.getKeyFrame(stateTimer, true);
        setRegion(region);
    ...
    public void defineItem() {
        ...
        fixtureDef.filter.categoryBits = Constants.RED_POITION_BIT;
