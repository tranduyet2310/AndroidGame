...
public class RedTotem extends Enemy{
    ...
    public RedTotem(PlayScreen screen, float x, float y) {
        super(screen, x, y);
    ...
    public void initAnimation(Array<TextureRegion> frames) {
        ...
        frames.add(new TextureRegion(Utils.getRegion("enemy/Totems/Head 2/Idle/1.png")));
        totemIdle = new Animation<TextureRegion>(0.4f, frames);
        frames.clear();
        for (int i = 1; i <= 6; i++) {
            frames.add(new TextureRegion(Utils.getRegion("enemy/Totems/Head 2/Attack/" + i + ".png")));
        }
        totemAttack = new Animation<TextureRegion>(0.4f, frames);
        frames.clear();
        for (int i = 1; i <= 6; i++) {
            frames.add(new TextureRegion(Utils.getRegion("enemy/Totems/Head 2/Destroyed/" + i + ".png")));
        }
        totemDead = new Animation<TextureRegion>(0.4f, frames);
        frames.clear();
        for (int i = 1; i <= 4; i++) {
            frames.add(new TextureRegion(Utils.getRegion("enemy/Totems/Head 2/Hit/" + i + ".png")));
        }
